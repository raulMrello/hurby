/*************************************************************************************
		This file is the implementation file of the Ear class
 *************************************************************************************/
...
/** Constructor **********************************************************************/
Ear::Ear(uint8_t id, Servo * pin, void (*OnMoveCallback)(void*, void*), void *moveScope){
	// setup default data
    this->servo = pin;
	this->type = id;
...
/** Movement service *****************************************************************/
void Ear::Move(uint8_t mcode, uint8_t speed, float percent){  
...
void Ear::OnMoveCallback(void){
	...
	if(++this->idStep < this->numSteps){
		this->tmr.attach(this, &Ear::OnMoveCallback, UPDATE_PACE);
		return;
	}
